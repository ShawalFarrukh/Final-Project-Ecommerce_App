...
For my project, when deciding on my technology stack, I decided to go with what I was familiar which was a lot of the technologies in CS50x. I used Flask as my microservice, where I wrote my routes in Python. I used SQLite for creating a database, creating tables and storing data in them, and also querying my tables in my code for things such as displaying products as well as inserting data, such as new order data for a user.
